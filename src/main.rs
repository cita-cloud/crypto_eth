...
const GIT_HOMEPAGE: &str = "https://github.com/cita-cloud/crypto_eth";
...
use crate::eth::{check_transactions, ADDR_BYTES_LEN, SECP256K1_SIGNATURE_BYTES_LEN};
...
impl CryptoService for CryptoServer {
    async fn get_crypto_info(
        ...
        Ok(Response::new(GetCryptoInfoResponse {
            ...
            hash_len: eth::HASH_BYTES_LEN as u32,
            signature_len: eth::SECP256K1_SIGNATURE_BYTES_LEN as u32,
            address_len: eth::ADDR_BYTES_LEN as u32,
        }))
    }
